          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="h-screen w-full flex justify-center items-center py-5">
              <div>
                ...
                JOIN US FOR A <br />{" "}
                  <span className="text-[clamp(0.8rem,5vw,2rem)]">HEALTHIER FUTURE</span>{" "}
                </h1>

                <div className=" h-fit md:my-10 ">
                  <div className="flex flex-col mb-5">
                    <label htmlFor="user_name" className="text-sm text-gray-400">User Name</label>
                    <input
                      type="text"
                      className={`border-b md:h-10 h-6  p-2 ${
